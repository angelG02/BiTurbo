...
pub enum Event {
    None = 0,
	WindowClose, WindowResize(i32, i32), WindowFocus, WindowLostFocus, WindowMoved,
	KeyPressed(glfw::Key, i32), KeyReleased(glfw::Key), KeyTyped(glfw::Key),
	MouseButtonPressed(glfw::MouseButton), MouseButtonReleased(glfw::MouseButton), MouseMoved(f32, f32), MouseScrolled(f32, f32),
	Handled
}
...
impl Event {
	pub fn get_category_flags(&self) -> u8 {
		match *self {
			...
			Self::MouseButtonPressed(_) 	=> EventCategory::Input as u8 | EventCategory::Mouse as u8 | EventCategory::MouseButton as u8,
			Self::MouseButtonReleased(_)	=> EventCategory::Input as u8 | EventCategory::Mouse as u8 | EventCategory::MouseButton as u8,
